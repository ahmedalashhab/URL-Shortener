...
const Footer = () => {
  return (
    <section className="flex justify-center h-80 footer-background">
      <div className="flex w-3/4 justify-between mt-16">
        <div>
        ...
        <div className="flex gap-24">
          <div className="flex flex-col gap-1.5">
            <span className="poppins-700 text-white mb-4 ">Features</span>
            <span className="poppins-500 fourth-color cursor-pointer hover:text-teal-400">
              Link Shortening
            </span>
            <span className="poppins-500 fourth-color cursor-pointer hover:text-teal-400">
              Branded Links
          ...
          <div className="flex flex-col gap-1.5">
            <span className="poppins-700 text-white mb-4">Resources</span>
            <span className="poppins-500 fourth-color cursor-pointer hover:text-teal-400">
              Blog
            </span>
            <span className="poppins-500 fourth-color cursor-pointer hover:text-teal-400">
          ...
          <div className="flex flex-col gap-1.5">
            <span className="poppins-700 text-white mb-4">Company</span>
            <span className="poppins-500 fourth-color cursor-pointer hover:text-teal-400">
              About
            </span>
            <span className="poppins-500 fourth-color cursor-pointer hover:text-teal-400">
        ...
        <div className="flex gap-8">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
              <path
                className="hover:fill-teal-400 cursor-pointer"
                fill="#FFF"
